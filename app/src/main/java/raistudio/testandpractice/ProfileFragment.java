...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        usernameView=(TextView)view.findViewById(R.id.profile_username_view);
        emailView=(TextView)view.findViewById(R.id.profile_email_view);
        passwordView=(TextView)view.findViewById(R.id.profile_password_view);
        imageView=(ImageView)view.findViewById(R.id.profile_image_view);
        editView=(Button) view.findViewById(R.id.edit_profile_view);
        ...
        String connectedEmail=sharedPreferences.getString("connected_email","");
        if (!connectedEmail.isEmpty()) {
            emailView.setText(connectedEmail);
        }
        ...
        String connectedPassword=sharedPreferences.getString("connected_password","");
        if (!connectedPassword.isEmpty()) {
            passwordView.setText(connectedPassword);
        }

        editView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment genericFragment=new EditProfileFragment();
